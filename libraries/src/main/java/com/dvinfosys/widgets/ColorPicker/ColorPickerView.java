...
public class ColorPickerView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        borderColor = a.getColor(R.styleable.ColorPickerView_dv_borderColor, 0xFF6E6E6E);
        a.recycle();
        ...
        mRequiredPadding = getResources().getDimensionPixelSize(R.dimen.required_padding);
