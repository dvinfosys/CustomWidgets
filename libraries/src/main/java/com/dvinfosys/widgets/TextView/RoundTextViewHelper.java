...
public class RoundTextViewHelper {
    ...
    public static final class Builder implements Parcelable {
        ...
        RoundTextView.AnimationProgressStyle animationProgressStyle;
        ...
        Builder(Parcel in) {
            ...
            this.animationProgressStyle = tmpAnimationProgressStyle == -1 ? null : RoundTextView.AnimationProgressStyle.values()[tmpAnimationProgressStyle];
        ...
        public Builder withAnimationProgressStyle(RoundTextView.AnimationProgressStyle animationProgressStyle) {
