...
public class DToast {
    ...
    public static class makeToast {
        ...
        public void show() {
            ...
            messageTV = dialog.findViewById(R.id.d_toast_text);
            iconImg = dialog.findViewById(R.id.d_toast_icon);
            background = dialog.findViewById(R.id.background);
