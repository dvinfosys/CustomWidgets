...
public class ToggleButton extends ToggleableView {
    ...
    private void initProperties(AttributeSet attrs) {
        ...
        for (int i = 0; i < N; ++i) {
            ...
            if (attr == R.styleable.ToggleButton_tb_on) {
                isOn = tarr.getBoolean(R.styleable.ToggleButton_tb_on, false);
            } else if (attr == R.styleable.ToggleButton_tb_colorOff) {
                colorOff = tarr.getColor(R.styleable.ToggleButton_tb_colorOff, Color.parseColor("#FFFFFF"));
            } else if (attr == R.styleable.ToggleButton_tb_colorBorder) {
                int accentColor;
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                ...
                colorBorder = tarr.getColor(R.styleable.ToggleButton_tb_colorBorder, accentColor);
            } else if (attr == R.styleable.ToggleButton_tb_colorOn) {
                int accentColor;
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    accentColor = getResources().getColor(R.color.colorAccent, getContext().getTheme());
                } else {
                ...
                colorOn = tarr.getColor(R.styleable.ToggleButton_tb_colorOn, accentColor);
            } else if (attr == R.styleable.ToggleButton_tb_colorDisabled) {
                colorDisabled = tarr.getColor(R.styleable.ToggleButton_tb_colorOff, Color.parseColor("#D3D3D3"));
            } else if (attr == R.styleable.ToggleButton_tb_textOff) {
...
//      Drawing Switch Thumb here
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int desiredWidth = getResources().getDimensionPixelSize(R.dimen.tb_default_width);
        int desiredHeight = getResources().getDimensionPixelSize(R.dimen.tb_default_height);
