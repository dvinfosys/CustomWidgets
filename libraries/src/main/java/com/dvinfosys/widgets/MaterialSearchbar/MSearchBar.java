...
public class MSearchBar extends RelativeLayout implements View.OnClickListener,
    ...
    public MSearchBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public MSearchBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MSearchBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init(attrs);
    }

    private void init(AttributeSet attrs) {
        inflate(getContext(), R.layout.msearchbar, this);

        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.MSearchBar);

        //Base Attributes
        speechMode = array.getBoolean(R.styleable.MSearchBar_ms_speechMode, false);
        maxSuggestionCount = array.getInt(R.styleable.MSearchBar_ms_maxSuggestionsCount, 3);
        navButtonEnabled = array.getBoolean(R.styleable.MSearchBar_ms_navIconEnabled, false);
        roundedSearchBarEnabled = array.getBoolean(R.styleable.MSearchBar_ms_roundedSearchBarEnabled, false);
        menuDividerEnabled = array.getBoolean(R.styleable.MSearchBar_ms_menuDividerEnabled, false);
        dividerColor = array.getColor(R.styleable.MSearchBar_ms_dividerColor, ContextCompat.getColor(getContext(), R.color.searchBarDividerColor));
        searchBarColor = array.getColor(R.styleable.MSearchBar_ms_searchBarColor, ContextCompat.getColor(getContext(), R.color.searchBarPrimaryColor));

        //Icon Related Attributes
        menuIconRes = array.getResourceId(R.styleable.MSearchBar_ms_menuIconDrawable, R.drawable.ic_dots_vertical_black_48dp);
        searchIconRes = array.getResourceId(R.styleable.MSearchBar_ms_searchIconDrawable, R.drawable.ic_magnify_black_48dp);
        speechIconRes = array.getResourceId(R.styleable.MSearchBar_ms_speechIconDrawable, R.drawable.ic_microphone_black_48dp);
        arrowIconRes = array.getResourceId(R.styleable.MSearchBar_ms_backIconDrawable, R.drawable.ic_arrow_left_black_48dp);
        clearIconRes = array.getResourceId(R.styleable.MSearchBar_ms_clearIconDrawable, R.drawable.ic_close_black_48dp);
        navIconTint = array.getColor(R.styleable.MSearchBar_ms_navIconTint, ContextCompat.getColor(getContext(), R.color.searchBarNavIconTintColor));
        menuIconTint = array.getColor(R.styleable.MSearchBar_ms_menuIconTint, ContextCompat.getColor(getContext(), R.color.searchBarMenuIconTintColor));
        searchIconTint = array.getColor(R.styleable.MSearchBar_ms_searchIconTint, ContextCompat.getColor(getContext(), R.color.searchBarSearchIconTintColor));
        arrowIconTint = array.getColor(R.styleable.MSearchBar_ms_backIconTint, ContextCompat.getColor(getContext(), R.color.searchBarBackIconTintColor));
        clearIconTint = array.getColor(R.styleable.MSearchBar_ms_clearIconTint, ContextCompat.getColor(getContext(), R.color.searchBarClearIconTintColor));
        navIconTintEnabled = array.getBoolean(R.styleable.MSearchBar_ms_navIconUseTint, true);
        menuIconTintEnabled = array.getBoolean(R.styleable.MSearchBar_ms_menuIconUseTint, true);
        searchIconTintEnabled = array.getBoolean(R.styleable.MSearchBar_ms_searchIconUseTint, true);
        arrowIconTintEnabled = array.getBoolean(R.styleable.MSearchBar_ms_backIconUseTint, true);
        clearIconTintEnabled = array.getBoolean(R.styleable.MSearchBar_ms_clearIconUseTint, true);
        borderlessRippleEnabled = array.getBoolean(R.styleable.MSearchBar_ms_borderlessRippleEnabled, false);

        //Text Related Attributes
        hintText = array.getString(R.styleable.MSearchBar_ms_hint);
        placeholderText = array.getString(R.styleable.MSearchBar_ms_placeholder);
        textColor = array.getColor(R.styleable.MSearchBar_ms_textColor, ContextCompat.getColor(getContext(), R.color.searchBarTextColor));
        hintColor = array.getColor(R.styleable.MSearchBar_ms_hintColor, ContextCompat.getColor(getContext(), R.color.searchBarHintColor));
        placeholderColor = array.getColor(R.styleable.MSearchBar_ms_placeholderColor, ContextCompat.getColor(getContext(), R.color.searchBarPlaceholderColor));
        textCursorColor = array.getColor(R.styleable.MSearchBar_ms_textCursorTint, ContextCompat.getColor(getContext(), R.color.searchBarCursorColor));
        highlightedTextColor = array.getColor(R.styleable.MSearchBar_ms_highlightedTextColor, ContextCompat.getColor(getContext(), R.color.searchBarTextHighlightColor));
