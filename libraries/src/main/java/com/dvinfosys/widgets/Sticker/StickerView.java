...
public class StickerView extends FrameLayout {
    ...
    public StickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            borderPaint.setColor(a.getColor(R.styleable.StickerView_sv_borderColor, Color.BLACK));
    ...
    public void setShowIcons(@NonNull boolean showIcons) {
    ...
    public void setShowBorder(@NonNull boolean border) {
