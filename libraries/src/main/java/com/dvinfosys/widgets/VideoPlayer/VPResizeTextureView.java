...
public class VPResizeTextureView extends TextureView {
    protected static final String TAG = "JCResizeTextureView";

    // x as width, y as height
    protected Point mVideoSize;

    public VPResizeTextureView(Context context) {
        super(context);
        init();
    }

    public VPResizeTextureView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
